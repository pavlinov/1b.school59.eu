...
/*
    ...
    Author: Felix Wei
    Version: 1.0
    Author URI: http://www.felixweiphotography.com/
...
function gdml_media_actions()
{
    ...
    {
        add_media_page("Google Drive Media Library", "Google Drive Media Library", 1, "google-drive-media-library-management",
            "gdml_media");
